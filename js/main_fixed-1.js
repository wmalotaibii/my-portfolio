...
// ✅ Popup يظهر على الموبايل دائمًا
function isMobile() {
  ...
  // ✅ الأنيميشنات تشتغل فقط على الشاشات الكبيرة
  ...
  const username = "wmalotaibii"; // اسم المستخدم
  const repoName = "report-maker"; // اسم الريبو الجديد
